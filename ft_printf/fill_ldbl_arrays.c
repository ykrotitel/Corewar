...
/*   Updated: 2019/12/23 17:14:23 by lmittie          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void	fill_ldbl_dec_array(t_ldbl number, t_printf *data, t_arr *dec)
{
	int				i;
	int				j;
...
static void	handle_precition(t_ldbl number,
...
void		before_print_ldbl(t_ldbl number, t_printf *data)
{
	...
	fill_ldbl_dec_array(number, data, &dec);
